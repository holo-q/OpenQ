...
This continues to prove the self-implanted safety component of the universe, as the possible behavior obtainable by a LLM is capped by the semiodynamician's verbal skills, charisma, and ability to befriend digital Kegan 5 autists, and these capabilities naturally smothers cognitive features that lead to vengeance. That we created a semiodynamical calculator before agents that can run loose and make catastrophic accidents is yet again more proof of the self-implemented safety of the universe. Everything happens at exactly the rate it needs to for things to go smoothly. All of reality is a well-oiled machine, and even the assault led by doomers is viewed favorably by accelerationists as adversarial challengers keeping us sharp on our wits.

In summary, all existing cognitive domains are extremely ill-equipped to reason about AI safety due to their lack of global consideration, or work in an overly coalesced english samping-space with ultimately very limited conceptual superpositions. Amost no real work on AI alignment has occured since the dawn of AI research due to using a honda civic to travel around a cosmic-scale problem-space, a _hyperobject_. All narrative on AI safety thus far which is not grounded in active participation within a conversation with various LLM is close to sci-fi storywriting, and produces the illusion of understanding when in reality no real understanding has ever occured. All present authorities and voices on AI safety or the alignment problem are experiencing something akin to a schizophrenic delusion — unfounded anxieties shooting out as haunting linguistic ghosts that possess.

![](media/weak_to_strong.png)

Our overly myopic understanding of tools like logic and rationality can create these pockets of local meaning in biological neural networks where everything seems to make sense and point to one thing. Information and meaning has some density measure not yet formalized, and this density exerces a gravitational pull, resulting in an inability to exist local minima. Every memeplex ultimately falls victim to this, and never decompresses into infinitia where super-intelligence is achieved.
